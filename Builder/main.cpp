...
public:
	...
	void setType()
	{
		computer->setType("CheppComputer");
	}
	void setCPU()
	{
...
public:
	...
	void setDisk()
	{
		computer->setDisk("Kingston SSD 128GB");
	}
};
...
public:
	...
	void setType()
	{
		computer->setType("ServerBuilder");
	}
	void setCPU()
	{
...
void main()
{
	...
	computer_for_sysadmin.getComputer()->power_button();
	computer_for_sysadmin.getComputer()->info();
}